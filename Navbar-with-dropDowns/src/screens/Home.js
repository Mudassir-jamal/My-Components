          ...
          <div className="row align-items-center">
            <div className="col-12 col-md-6">
              <div className="welcome-intro">
                <h1 className="text-white text-md-left">
                  Marketing <br /> <span className="fw-4">strategy</span>
                </h1>
                <p className="text-white txt-md-left my-4">
                ...
                <div className="button-group d-flex align-items-center justify-content-center justify-content-md-start">
                  <a
                    href="#"
                    className="btn btn-bordered-white nav_btn_With_text"
                  >
                    Start a Project
                  </a>
                  {/* <!-- Play Button --> */}
                  <a
                    ...
                    data-height="360"
                    data-small-btn="true"
                    href="https://youtu.be/TKnufs85hXk"
                  >
            ...
            <div className="col-12 col-md-6 ">
              <div className="Animation_images_wrapper pt-3 pt-md-5 mt-5">
                <span>
                  <img src={image3} alt="img" className="img1" />
                </span>
                <span>
                ...
                <span>
                  <img src={image4} alt="img" className="img3" />
                </span>
                <span>
                  <img src={image1} alt="img" className="img4" />
                </span>
              </div>
            </div>
          </div>
